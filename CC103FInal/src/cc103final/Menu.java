...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        private void displayTasks() {
            ArrayList<String> tasks = TaskList.getList();
            if (tasks.isEmpty()) {
                NoTask2 fam = new NoTask2(this, true);
                fam.setVisible(true);
                this.dispose();
                } else {
                ViewTasks umm = new ViewTasks();
                umm.setVisible(true);
                this.dispose(); 
            }
        }
